...
import { Icon, StatCard } from "@fanation/ui";
    ...
    <div className="content">
      ...
      <div className="grid gap16" style={{ gridTemplateColumns: "1fr 1fr" }}>
        <div className="card" style={{ padding: 18 }}>
          ...
          {attention.map((a, i) => (
            <div key={i} className="row gap10" style={{ padding: "10px 0", cursor: "pointer" }} onClick={() => router.push(a[3])}>
        ...
        <div className="card" style={{ padding: 18 }}>
          <div className="row between" style={{ marginBottom: 14 }}>
            ...
            <span className="blue t13 b6" style={{ cursor: "pointer" }} onClick={() => router.push("/audit")}>Full audit log</span>
          </div>
