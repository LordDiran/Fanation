  ...
  return (
    <div className="glowbg row center" style={{ minHeight: "100vh", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 400 }}>
        <div className="row center gap10" style={{ marginBottom: 22 }}>
          <div className="logo">F</div>
          <div className="display t20" style={{ fontWeight: 600 }}>Fanation <span className="muted">Admin</span></div>
        </div>
        <div className="card" style={{ padding: 28 }}>
          <div className="row gap10" style={{ marginBottom: 6 }}>
            <div className="feature-ic" style={{ width: 38, height: 38, background: "rgba(46,155,255,.14)" }}><Icon n="shield" s={18} c="var(--blueL)" /></div>
