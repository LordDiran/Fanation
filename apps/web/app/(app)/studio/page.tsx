...
import { Avatar, Icon, StatCard, Verified } from "@fanation/ui";
    ...
    <div className="content">
      <div className="row between wrap" style={{ marginBottom: 20, gap: 12 }}>
        ...
        <div className="row gap10">
          ...
          <button className="btn btn-grad btn-sm" onClick={() => router.push("/studio/live")}><Icon n="live" s={15} />Go Live</button>
        </div>
      </div>
      ...
      <div className="card" style={{ marginTop: 16, padding: 18 }}>
        <div className="row between" style={{ marginBottom: 12 }}>
          ...
          <span className="blue t13 b6" style={{ cursor: "pointer" }} onClick={() => router.push("/explore")}>Browse all</span>
        </div>
        <div className="row gap24 wrap">
          {CREATORS.slice(0, 5).map((c) => (
            <div key={c.id} className="row gap10" style={{ cursor: "pointer" }} onClick={() => router.push(`/creator/${c.handle}`)}>
