    ...
    <div className="glowbg row center" style={{ minHeight: "100vh", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 460 }}>
        ...
        <div className="card" style={{ padding: 28 }}>
          ...
          <button className="btn btn-blue btn-block" onClick={() => { setAuthed(true); router.push("/feed"); }}>Create Account</button>
          <div className="row center muted t14" style={{ marginTop: 14, gap: 5 }}>
            Already have an account?
            <span className="blue b6" style={{ cursor: "pointer" }} onClick={() => router.push("/login")}>Log in</span>
          </div>
        </div>
      </div>
    </div>
